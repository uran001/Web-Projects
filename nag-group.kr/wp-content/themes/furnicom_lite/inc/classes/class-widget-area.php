...
if ( ! class_exists( 'Furnicom_lite_Widget_Area' ) ) {

	/**
	 * Class Furnicom_lite_Widget_Area.
	 */
	class Furnicom_lite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'furnicom_lite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'furnicom_lite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'furnicom_lite_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function furnicom_lite_widget_area() {
		return Furnicom_lite_Widget_Area::get_instance();
	}

	furnicom_lite_widget_area();
}
