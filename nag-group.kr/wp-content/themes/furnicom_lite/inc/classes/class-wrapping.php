 ...
 */
add_filter( 'template_include', array( 'Furnicom_lite_Wrapping', 'wrap' ), 99 );
add_filter( 'furnicom_lite_wrap_base', 'furnicom_lite_wrap_base_cpts' );
 ...
 */
function furnicom_lite_template_path() {
	return Furnicom_lite_Wrapping::$main_template;
}
 ...
 */
function furnicom_lite_template_base() {
	return Furnicom_lite_Wrapping::$base;
}

if ( ! class_exists( 'Furnicom_lite_Wrapping' ) ) {
	...
	class Furnicom_lite_Wrapping {
		...
		/**
		 * Initialize new instance of Furnicom_lite_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'furnicom_lite_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Furnicom_lite_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Furnicom_lite_Wrapping();
		}
	}
}
 ...
 */
function furnicom_lite_wrap_base_cpts( $templates ) {
