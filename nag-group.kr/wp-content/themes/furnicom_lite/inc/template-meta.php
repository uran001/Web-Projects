 ...
 * @return array
 */
function furnicom_lite_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	if ( ! furnicom_lite_is_meta_visible( $meta, $context ) ) {
		return;
	}
	...
	$defaults = apply_filters( 'furnicom_lite_default_args_share_buttons', array(
		...
		'pinterest' => array(
			...
			'name'      => esc_html__( 'Pinterest', 'furnicom_lite' ),
	...
	$default_config = apply_filters( 'furnicom_lite_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'furnicom_lite_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'furnicom_lite' ) . $network['name'],
 ...
 * @return string
 */
function furnicom_lite_get_single_share_buttons() {
	ob_start();
